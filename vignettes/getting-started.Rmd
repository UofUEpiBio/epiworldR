...
repeats until all data have been accounted for. For example, on average, 
individuals who acquired the virus on the 10th day transmit the virus to roughly 1.7 other individuals. 
...
transitions between states. Although the function `get_hist_transitions` provides the desired data, the function `plot_incidence` is a nice wrapper for visualizing the data:
