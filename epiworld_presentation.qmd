...
Epiworld makes use of agent based modeling. That is, it is a computational model with the purpose of simulating the interactions of autonomous agents (people). Due to the ABM structure of epiworld, the ability to analyze the effects of diseases like COVID and the Flu on populations given specified parameters reflecting human interaction can be done in seconds.
...
3.  SEIR - Susceptible - Exposed - Infected - Recovered
