...
add_virus.epiworld_sir <- function(m, v, prevalence) {
  ...
  invisible(add_virus_cpp(m, v, prevalence))
...
add_virus.epiworld_seir <- function(m, v, prevalence) {
  ...
  virus_set_state(v, init = 1, end = 3, removed = 3)
  invisible(add_virus_cpp(m, v, prevalence))
...
add_virus.epiworld_seirconn <- function(m, v, prevalence) {
  ...
  add_virus.epiworld_seir(m, v, prevalence)
...
add_virus_n.epiworld_model <- function(m, v, prevalence) {
  ...
  invisible(add_virus_n_cpp(m, v, prevalence))
  
}

#' @export
add_virus_n.epiworld_sir <- function(m, v, prevalence) {
  
  virus_set_state(m, init = 1, end = 2, removed = 2)
  invisible(add_virus_n_cpp(m, v, prevalence))
  
}

#' @export
add_virus_n.epiworld_sirconn <- function(m, v, prevalence) {
  
  add_virus_n.epiworld_sir(m, v, prevalence)
  
}

#' @export
add_virus_n.epiworld_seir <- function(m, v, prevalence) {
  
  virus_set_state(m, init = 1, end = 3, removed = 3)
  invisible(add_virus_n_cpp(m, v, prevalence))
  
}

#' @export
add_virus_n.epiworld_seirconn <- function(m, v, prevalence) {
  
  add_virus_n.epiworld_seir(m, v, prevalence)
...
virus_set_state <- function(v, init, end, removed) {
  ...
  invisible(virus_set_state_cpp(v, init, end, removed))
